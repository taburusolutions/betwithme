<div class="span9">
    <div class="row row-wrap">
        ...
        <div class="row">
            <div class="span8">
                <h4 class="mb20">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Completed Matches <small><a href="#">View All</a> </small></h4>
            </div>
        ...
        <div class="span3">
            ...
            <a href="#" class="coupon-thumb">
                ...
                <div class="coupon-inner">
                    ...
                    <div class="coupon-meta"><span class="coupon-time">5 days 46 h remaining</span>Ronald Windwaai
                        <div class="coupon-price"><span class="coupon-old-price"></span><span class="coupon-new-price">View</span>
                        </div>
                    </div>
                </div>
            </a>
