...
<script src="{{asset('assets/dashboard/plugins/perfect-scrollbar/perfect-scrollbar.min.js')}}" type="text/javascript"></script>
<script src="{{asset('assets/dashboard/plugins/viewport/viewportchecker.js')}}" type="text/javascript"></script>
...
<script src="{{asset('assets/dashboard/js/scripts.js')}}" type="text/javascript"></script>
<!-- END CORE TEMPLATE JS - END -->

<!-- Sidebar Graph - START -->
<script src="{{asset('assets/dashboard/plugins/sparkline-chart/jquery.sparkline.min.js')}}" type="text/javascript"></script>
<script src="{{asset('assets/dashboard/js/chart-sparkline.js')}}" type="text/javascript"></script>
<!-- Sidebar Graph - END -->
